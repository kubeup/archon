...
func DeepCopy_audit_Event(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if newVal, err := c.DeepCopy(&in.Timestamp); err != nil {
			return err
		} else {
			out.Timestamp = *newVal.(*v1.Time)
		}
		if err := DeepCopy_audit_UserInfo(&in.User, &out.User, c); err != nil {
			return err
		}
		if in.ImpersonatedUser != nil {
			in, out := &in.ImpersonatedUser, &out.ImpersonatedUser
			*out = new(UserInfo)
			if err := DeepCopy_audit_UserInfo(*in, *out, c); err != nil {
				return err
			}
		}
		if in.SourceIPs != nil {
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]Event, len(*in))
			for i := range *in {
				if err := DeepCopy_audit_Event(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		...
		*out = *in
		...
		if in.Rules != nil {
			...
			*out = make([]PolicyRule, len(*in))
			for i := range *in {
				if err := DeepCopy_audit_PolicyRule(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]Policy, len(*in))
			for i := range *in {
				if err := DeepCopy_audit_Policy(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		...
		*out = *in
		...
		if in.Resources != nil {
			...
			*out = make([]GroupResources, len(*in))
			for i := range *in {
				if err := DeepCopy_audit_GroupResources(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
