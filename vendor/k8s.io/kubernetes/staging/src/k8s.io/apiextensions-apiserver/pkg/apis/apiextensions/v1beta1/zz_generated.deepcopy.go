...
func DeepCopy_v1beta1_CustomResourceDefinition(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if err := DeepCopy_v1beta1_CustomResourceDefinitionSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_v1beta1_CustomResourceDefinitionStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]CustomResourceDefinition, len(*in))
			for i := range *in {
				if err := DeepCopy_v1beta1_CustomResourceDefinition(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
func DeepCopy_v1beta1_CustomResourceDefinitionSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if err := DeepCopy_v1beta1_CustomResourceDefinitionNames(&in.Names, &out.Names, c); err != nil {
			return err
		}
		return nil
	}
		...
		*out = *in
		if in.Conditions != nil {
			...
			*out = make([]CustomResourceDefinitionCondition, len(*in))
			for i := range *in {
				if err := DeepCopy_v1beta1_CustomResourceDefinitionCondition(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		if err := DeepCopy_v1beta1_CustomResourceDefinitionNames(&in.AcceptedNames, &out.AcceptedNames, c); err != nil {
			return err
		}
		return nil
	}
