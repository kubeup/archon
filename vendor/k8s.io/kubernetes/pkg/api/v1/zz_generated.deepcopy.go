...
func DeepCopy_v1_ContainerStateRunning(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if newVal, err := c.DeepCopy(&in.StartedAt); err != nil {
			...
			out.StartedAt = *newVal.(*meta_v1.Time)
		}
		return nil
	}
}
...
func DeepCopy_v1_ContainerStateTerminated(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if newVal, err := c.DeepCopy(&in.FinishedAt); err != nil {
			...
			out.FinishedAt = *newVal.(*meta_v1.Time)
		}
		return nil
	}
}
...
func DeepCopy_v1_Event(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if newVal, err := c.DeepCopy(&in.FirstTimestamp); err != nil {
			...
			out.FirstTimestamp = *newVal.(*meta_v1.Time)
		}
		if newVal, err := c.DeepCopy(&in.LastTimestamp); err != nil {
			return err
		} else {
			out.LastTimestamp = *newVal.(*meta_v1.Time)
		}
		return nil
	}
}
...
func DeepCopy_v1_NodeCondition(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if newVal, err := c.DeepCopy(&in.LastHeartbeatTime); err != nil {
			...
			out.LastHeartbeatTime = *newVal.(*meta_v1.Time)
		}
...
func DeepCopy_v1_ObjectMeta(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if newVal, err := c.DeepCopy(&in.CreationTimestamp); err != nil {
			...
			out.CreationTimestamp = *newVal.(*meta_v1.Time)
		}
...
func DeepCopy_v1_PreferAvoidPodsEntry(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if newVal, err := c.DeepCopy(&in.EvictionTime); err != nil {
			...
			out.EvictionTime = *newVal.(*meta_v1.Time)
		}
		return nil
	}
}
...
func DeepCopy_v1_Taint(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if newVal, err := c.DeepCopy(&in.TimeAdded); err != nil {
			...
			out.TimeAdded = *newVal.(*meta_v1.Time)
		}
		return nil
	}
}
