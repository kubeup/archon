...
func BuildGenericConfig(s *options.ServerRunOptions) (*genericapiserver.Config, informers.SharedInformerFactory, clientgoinformers.SharedInformerFactory, *kubeserver.InsecureServingInfo, aggregatorapiserver.ServiceResolver, error) {
	...
	// genericConfig.OpenAPIConfig = genericapiserver.DefaultOpenAPIConfig(nil, api.Scheme) //generatedopenapi.GetOpenAPIDefinitions, api.Scheme)
	...
	genericConfig.Authenticator, _, err = BuildAuthenticator(s, storageFactory, client, sharedInformers)
	if err != nil {
