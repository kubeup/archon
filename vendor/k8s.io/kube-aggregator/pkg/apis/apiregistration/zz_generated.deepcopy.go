...
func DeepCopy_apiregistration_APIService(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if err := DeepCopy_apiregistration_APIServiceStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
		...
		*out = *in
		if in.Conditions != nil {
			...
			*out = make([]APIServiceCondition, len(*in))
			for i := range *in {
				if err := DeepCopy_apiregistration_APIServiceCondition(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
