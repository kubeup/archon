...
func DeepCopy_v1beta1_APIService(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if err := DeepCopy_v1beta1_APIServiceSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_v1beta1_APIServiceStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]APIService, len(*in))
			for i := range *in {
				if err := DeepCopy_v1beta1_APIService(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		...
		*out = *in
		if in.Conditions != nil {
			...
			*out = make([]APIServiceCondition, len(*in))
			for i := range *in {
				if err := DeepCopy_v1beta1_APIServiceCondition(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
