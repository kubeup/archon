	...
	for yyj441 := 0; ; yyj441++ {
		...
		case "UsePrivateIP":
			if r.TryDecodeAsNil() {
				...
				x.UsePrivateIP = string(r.DecodeString())
			}
		default:
...
func (x *InstanceDependency) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq446[0] = true
			yyq446[1] = len(x.Secrets) != 0
			yyq446[2] = len(x.Users) != 0
			var yynn446 int
			if yyr446 || yy2arr446 {
				r.EncodeArrayStart(3)
			} else {
...
func (x *InstanceDependency) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceapi_Secret((*[]pkg2_api.Secret)(yyv466), d)
		}
	}
	yyj464++
	if yyhl464 {
...
func (x *Instance) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		yyct488 := r.ContainerType()
		if yyct488 == codecSelferValueTypeMap1234 {
		...
		} else if yyct488 == codecSelferValueTypeArray1234 {
...
func (x *InstanceSpec) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq502[0] = x.OS != ""
			yyq502[1] = x.Image != ""
			yyq502[2] = x.InstanceType != ""
			yyq502[3] = x.NetworkName != ""
			yyq502[4] = len(x.Files) != 0
			yyq502[5] = len(x.Secrets) != 0
			yyq502[6] = len(x.Configs) != 0
			yyq502[7] = len(x.Users) != 0
			yyq502[8] = x.Hostname != ""
			var yynn502 int
			if yyr502 || yy2arr502 {
		...
		case "files":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceFileSpec((*[]FileSpec)(yyv537), d)
				}
			}
		case "secrets":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceLocalObjectReference((*[]LocalObjectReference)(yyv539), d)
				}
			}
		case "configs":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceConfigSpec((*[]ConfigSpec)(yyv541), d)
				}
			}
		case "users":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceLocalObjectReference((*[]LocalObjectReference)(yyv543), d)
				}
			}
		case "hostname":
			if r.TryDecodeAsNil() {
...
func (x codecSelfer1234) decSliceapi_Secret(v *[]pkg2_api.Secret, d *codec1978.Decoder) {
	...
	if yyl701 == 0 {
		...
		if yyl701 > cap(yyv701) {
			...
			yyv2701 := yyv701
			yyrl701, yyrt701 = z.DecInferLen(yyl701, z.DecBasicHandle().MaxInitLen, 304)
			if yyrt701 {
...
func (x codecSelfer1234) decSliceUser(v *[]User, d *codec1978.Decoder) {
	...
	if yyl707 == 0 {
		...
		if yyl707 > cap(yyv707) {
			...
			yyv2707 := yyv707
			yyrl707, yyrt707 = z.DecInferLen(yyl707, z.DecBasicHandle().MaxInitLen, 336)
			if yyrt707 {
