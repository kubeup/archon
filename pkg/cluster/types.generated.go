...
func (x *InstanceSpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceFileSpec((*[]FileSpec)(yyv33), d)
		}
	}
	yyj23++
	if yyhl23 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceLocalObjectReference((*[]LocalObjectReference)(yyv35), d)
		}
	}
	yyj23++
	if yyhl23 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceConfigSpec((*[]ConfigSpec)(yyv37), d)
		}
	}
	yyj23++
	if yyhl23 {
