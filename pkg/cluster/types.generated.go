		...
		case "items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSlicePtrtoUser((*[]*User)(yyv10), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *UserList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicePtrtoUser((*[]*User)(yyv19), d)
		}
	}
	for {
		yyj12++
		...
		case "items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSlicePtrtoNetwork((*[]*Network)(yyv10), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *NetworkList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicePtrtoNetwork((*[]*Network)(yyv19), d)
		}
	}
	for {
		yyj12++
		...
		case "items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSlicePtrtoInstanceGroup((*[]*InstanceGroup)(yyv10), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *InstanceGroupList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicePtrtoInstanceGroup((*[]*InstanceGroup)(yyv19), d)
		}
	}
	for {
		yyj12++
...
func (x *InstanceDependency) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicev1_Secret((*[]pkg3_v1.Secret)(yyv11), d)
		}
	}
	yyj9++
	if yyhl9 {
...
func (x *InstanceSpec) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[4] = len(x.Files) != 0
			yyq2[5] = len(x.Secrets) != 0
			yyq2[6] = len(x.Configs) != 0
			yyq2[7] = len(x.Users) != 0
			yyq2[8] = x.Hostname != ""
			var yynn2 int
			if yyr2 || yy2arr2 {
		...
		case "files":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceFileSpec((*[]FileSpec)(yyv12), d)
				}
			}
		case "secrets":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceLocalObjectReference((*[]LocalObjectReference)(yyv14), d)
				}
			}
		case "configs":
			if r.TryDecodeAsNil() {
		...
		case "users":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceLocalObjectReference((*[]LocalObjectReference)(yyv18), d)
				}
			}
		case "hostname":
			if r.TryDecodeAsNil() {
...
func (x *InstanceSpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceFileSpec((*[]FileSpec)(yyv31), d)
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceConfigSpec((*[]ConfigSpec)(yyv35), d)
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceLocalObjectReference((*[]LocalObjectReference)(yyv37), d)
		}
	}
	yyj22++
	if yyhl22 {
		...
		case "items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSlicePtrtoInstance((*[]*Instance)(yyv10), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *InstanceList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicePtrtoInstance((*[]*Instance)(yyv19), d)
		}
	}
	for {
		yyj12++
...
func (x codecSelfer1234) decSlicePtrtoUser(v *[]*User, d *codec1978.Decoder) {
	...
	if yyl1 == 0 {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, nil) // var yyz1 *User
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
...
func (x codecSelfer1234) decSlicePtrtoNetwork(v *[]*Network, d *codec1978.Decoder) {
	...
	if yyl1 == 0 {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, nil) // var yyz1 *Network
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
...
func (x codecSelfer1234) decSlicePtrtoInstanceGroup(v *[]*InstanceGroup, d *codec1978.Decoder) {
	...
	if yyl1 == 0 {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, nil) // var yyz1 *InstanceGroup
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
...
func (x codecSelfer1234) decSlicePtrtoInstance(v *[]*Instance, d *codec1978.Decoder) {
	...
	if yyl1 == 0 {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, nil) // var yyz1 *Instance
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
